...
test('should replace the given word in the sentence', (t) => {
  t.is(replace('Let us go to the store', 'store', 'mall'), 'Let us go to the mall');
  t.is(replace('This has a spellngi error', 'spellngi', 'spelling'), 'This has a spelling error');
  t.is(replace('Let us get back to more coding', 'coding', 'algorithms'), 'Let us get back to more algorithms');
});
